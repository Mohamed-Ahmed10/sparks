  ...
  return (
    <input
      ...
      className={cn(
        ...
        "aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive border-b-2 border-white placeholder:text-white placeholder:font-bold",
        className
      )}
      {...props}
    />
