        ...
        <div className="container mx-auto lg:p-6 my-10">
            <div className="grid lg:grid-cols-5 my-8 gap-10 lg:gap-16">
                <div className="col-span-3">
                    <h1 className="text-5xl font-black flex capitalize">
                        <span className="text-[var(--main)] me-1">{serviceTranslation.red_title}</span>
                        <span>{serviceTranslation.black_title}</span>
                    </h1>
                    <p className="mt-10 text-3xl font-semibold">{serviceTranslation.description}</p>
                    <Button href="/contact-us" variant="foldable" className="mt-20">{t('send_request')}</Button>
                </div>
            ...
            <div className="text-center">
                <h2 className="text-center mx-auto w-11/12 lg:w-3/4 text-3xl sm:text-2xl md:text-3xl lg:text-4xl flex gap-1 font-bold flex-wrap justify-center">
                ...
                <p className="font-semibold">{t('services.benefits_desc')}</p>
            </div>
            <ul className="my-6">
            ...
            <div className="text-center font-semibold">
                ...
                <Button href="/portfolio" variant="foldable" className="mt-20">{t('view_full_portfolio')}</Button>
                <p className="mt-16 text-3xl">{t('services.last_desc')}</p>
            </div>
        </div >
    )
}
